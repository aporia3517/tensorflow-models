...
class Logistic(distribution.Distribution):
  ...
  def __init__(self,
    ...
    with ops.name_scope(name, values=[loc, scale]):
      with ops.control_dependencies([check_ops.assert_positive(scale)] if
        ...
        check_ops.assert_same_float_dtype([self._loc, self._scale, self._gumbel_noise])
    super(Logistic, self).__init__(
        ...
        graph_parents=[self._loc, self._scale], # self._gumbel_noise
        name=name)
  ...
  def _sample_n(self, n, seed=None):
    ...
    print((sampled * self.scale + self.loc).shape)

    return sampled * self.scale + self.loc"""
    
    #print(self.gumbel_noise.shape, self.scale.shape, self.loc.shape)
    #print((self.gumbel_noise * self.scale + self.loc).shape)
    return self.gumbel_noise * self.scale + self.loc
